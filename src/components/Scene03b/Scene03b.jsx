...
export default function Scene03b() {
  ...
  return (
    <section ref={sectionRef} className="scene03b">
      <div className="scene03b-image-container">
        <div className={`scene03b-image ${imageVisible ? 'visible' : ''}`}>
          <div className={`morph-image morph-a ${morphActive ? 'fade-out' : ''}`}>
            <img src="/pictures/without graffiti 3.png" alt="Without graffiti" />
          </div>
          <div className={`morph-image morph-b ${morphActive ? 'fade-in' : ''}`}>
            <img src="/pictures/with graffiti 3.PNG" alt="With graffiti" />
          </div>
        </div>
      </div>
    </section>
